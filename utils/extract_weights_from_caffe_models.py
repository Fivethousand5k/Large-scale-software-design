...
# P-Net
net = caffe.Net('models/det1.prototxt', 'models/det1.caffemodel', caffe.TEST)
np.save('src/weights/pnet.npy', get_all_weights(net))

# R-Net
net = caffe.Net('models/det2.prototxt', 'models/det2.caffemodel', caffe.TEST)
np.save('src/weights/rnet.npy', get_all_weights(net))

# O-Net
net = caffe.Net('models/det3.prototxt', 'models/det3.caffemodel', caffe.TEST)
