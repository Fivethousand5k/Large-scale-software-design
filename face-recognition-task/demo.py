...
configurations = {
    1: dict(
        ...
        step_size=100000, # "lr_policy: step"
...
def main():
    ...
    parser.add_argument('--cmd', type=str, default="train" ,choices=['train', 'test', 'extract'], help='train, test or extract')
    ...
    parser.add_argument('--dataset_dir', type=str, default="/home/wq/MyDatasets/OldFriends(resized224)/", help='dataset directory')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default="/home/wq/MySoftwareDesign/checkpoints3",
    ...
    parser.add_argument('--weight_file', type=str, default="/home/wq/MySoftwareDesign/PKL/resnet50_ft_weight.pkl", help='weight file')
    parser.add_argument('--gpu', type=int, default=1)
    parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',
                        help='number of data loading workers (default: 4)')
    parser.add_argument('--horizontal_flip', action='store_true', 
                        help='horizontally flip images specified in test_img_list_file')
    parser.add_argument('--training_dataset_root', default="/home/wq/MyDatasets/OldFriends(resized224)/")
    parser.add_argument('--testing_dataset_root', default="/home/wq/MyDatasets/OldFriends-for-test(resized224)/")
    ...
    testing_dataset_root=args.testing_dataset_root
    kwargs = {'num_workers': args.workers, 'pin_memory': True} if cuda else {}

    if args.cmd == 'train':
        dt = datasets.VGG_Faces2(training_dataset_root,split='train')
        train_loader = torch.utils.data.DataLoader(dt, batch_size=args.batch_size, shuffle=True, **kwargs)

    dv = datasets.VGG_Faces2(testing_dataset_root,split='valid',
    ...
    if args.cmd == 'train':
        optim = torch.optim.SGD(
            [
                ...
                #{'params': get_parameters(model, bias=True), 'lr': cfg['lr'] * 1, 'weight_decay': 0},
            ],
            lr=cfg['lr'],
